...
const BestPicturesWinnerList = () => {
    const [titles, setTitles] = useState([]);
    const getTitleRequest = async () => {

        const api_key = "k_8v24mym4";
        const url = `https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?groups=oscar_best_picture_winners&count=100`
    ...
    return (
        <div className="list-holiday">
            <span className="listTitle">Best pictures-winning titles</span>
...
export default BestPicturesWinnerList