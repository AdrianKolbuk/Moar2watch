...
const GoldenGlobeWinnerList = () => {
    const [titles, setTitles] = useState([]);
    const getTitleRequest = async () => {

        const url = `https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?groups=golden_globe_winners&count=100`
    ...
    return (
        <div className="list-holiday">
            <span className="listTitle">Golden Globe-winning titles</span>
...
export default GoldenGlobeWinnerList