...
const ScifiFantasyTitleList = () => {
    ...
    const getTitleRequest = async () => {
        ...
        const url = "https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=tv_series,tv_miniseries&genres=fantasy,sci_fi&count=100";
    ...
    return (
        <Container id="search-container" fluid>
            <span className="listTitleFilms">Sci-fi and fantasy series</span>
            <Row className="px-5">
