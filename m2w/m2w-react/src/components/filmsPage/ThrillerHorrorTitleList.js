...
const ThrillerHorrorTitleList = () => {
    ...
    const getTitleRequest = async () => {
        ...
        const url = "https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=feature,tv_movie&genres=horror,thriller&count=100";
    ...
    return (
        <Container id="search-container" fluid>
            <span className="listTitleFilms">Thriller and horror movies</span>
