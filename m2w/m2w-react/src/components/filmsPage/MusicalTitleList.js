...
const MusicalTitleList = () => {
    ...
    const getTitleRequest = async () => {
        ...
        const url = "https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=feature,tv_movie&genres=musical&count=100";
    ...
    return (
        <Container id="search-container" fluid>
            <span className="listTitleFilms">Musical movies</span>
