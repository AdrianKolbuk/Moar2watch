...
const TopDisneyMovies = () => {
    const [titles, setTitles] = useState([]);
    const getTitleRequest = async () => {

        const url = `https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=feature,tv_movie&genres=family&companies=disney&count=100`
    ...
    return (
        <div className="list-holiday">
            <span className="listTitle">Top Disney movies for family</span>
...
export default TopDisneyMovies