...
const TopAnimatedMovies = () => {
    ...
    const getTitleRequest = async () => {
        ...
        const url = `https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=feature,tv_movie&genres=animation&count=100`
    ...
    return (
        <div className="list-holiday">
            <span className="listTitle">Top animated movies</span>
...
export default TopAnimatedMovies