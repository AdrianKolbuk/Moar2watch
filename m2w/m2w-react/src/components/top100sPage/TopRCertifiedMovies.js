...
const TopRCertifiedMovies = () => {
    const [titles, setTitles] = useState([]);
    const getTitleRequest = async () => {

        const api_key = "k_8v24mym4";
        const url = `https://imdb-api.com/API/AdvancedSearch/k_8v24mym4?title_type=feature,tv_movie&certificates=us:R&count=100`
    ...
    return (
        <div className="list-holiday">
            <span className="listTitle">Top R Certified movies</span>
...
export default TopRCertifiedMovies